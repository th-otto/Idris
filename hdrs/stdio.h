...
int fseek __((FILE *stream, long offset, int whence));
...
int vscanf __((const char *format, va_list arg));
int vfscanf __((FILE *stream, const char *format, va_list arg));
int vsscanf __((const char *s, const char *format, va_list arg));
